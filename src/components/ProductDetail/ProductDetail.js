                        ...
                        <div className="row">
                            <div className="col-lg-8 col-md-12">
                                <div className="item-preview">
                                    <img src={"/home/rania/Downloads/React-Ecommerce-App-with-Redux-master (2)/src/images/solife.png"} alt="" className="img-fluid"/>
                                        ...
                                        <div className="fade show tab-pane product-tab active" id="product-comment" role="tabpanel"
                                            ...
                                            <div className="thread">
                                                ...
                                                <textarea name="reply-comment"
                                                          placeholder="Write your comment..."></textarea>
                                                                <button className="btn btn--sm btn-primary">Post
                                                                    Comment
                                                                </button>
                                                            </form>
                                                        </div>
                                        ...
                                        <ul className="infos">
                                            ...
                                            <li>
                                                <div className="author-btn">
                                                    <a href="#" className="btn btn--sm btn-secondary">Send Email</a>
                                                </div>
